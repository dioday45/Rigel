...
public class AngleTest {
    ...
    void normalizePositiveWorksOnWholeTurns() {
        ...
        System.out.println(Angle.normalizePositive(3*PI));
        System.out.println(Angle.toDeg(Angle.normalizePositive(7 * PI / 2)));
    }
    ...
    void ofDMSWorksOnKnownValues() {
        ...
        assertEquals(0, Angle.ofDMS(0,0,0));
    }
    ...
    @Test
    void ofDMSFailsWithNegativeDegrees(){
        assertThrows(IllegalArgumentException.class, () -> {
            Angle.ofDMS(-1, 0, 0);
        });
    }
